    ...
    function prefillFromBusiness() {
      ...
      if (!document.getElementById('neighborhood').value.trim()) document.getElementById('neighborhood').value = business.neighborhood || '';
      if (!document.getElementById('street').value.trim()) document.getElementById('street').value = business.street || '';
      if (!document.getElementById('doorNo').value.trim()) document.getElementById('doorNo').value = business.doorNo || '';
    ...
    function openLicenseModal(id) {
      ...
      if (id) {
        ...
        document.getElementById('doorNo').value = item.doorNo || '';
    ...
    function renderLicenseTable() {
      ...
      for (var i = 0; i < rows.length; i++) {
        ...
        if (item.followupDateText) applicationBits.push('<div class="cell-sub">Takip Tarihi: ' + escapeHtml(item.followupDateText) + '</div>');
