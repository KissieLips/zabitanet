    ...
    function renderAttendanceSheet() {
      ...
      if (infoBox) infoBox.textContent = 'Toplam ' + attendanceSheet.length + ' satıcı var. Filtreye göre ' + rows.length + ' satır gösteriliyor. Liste bölüm, renk ve yer numarasına göre sıralanır. Üreticide önce Yeşil, sonra Kırmızı gelir.';
      if (!rows.length) {
