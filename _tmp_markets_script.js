    ...
    function printLeaveReport() {
      ...
      var activeText = document.getElementById('leaveActiveFilter').selectedOptions[0] ? document.getElementById('leaveActiveFilter').selectedOptions[0].textContent : 'Tüm Kayıtlar';
      ...
      var tableRows = rows.map(function(item) {
        return '<tr>' +
          ...
          '<td>' + escapeHtml((item.startDateText || '-') + ' - ' + (item.endDateText || '-')) + '</td>' +
      ...
      var reportHtml = '' +
        ...
        '<div class="meta-grid">' +
          ...
          '<div class="meta-card" style="grid-column:1/-1;"><div class="meta-label">Görünüm</div><div class="meta-value">' + escapeHtml(activeText) + '</div></div>' +
        '</div>' +
